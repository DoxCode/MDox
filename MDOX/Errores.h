...
class Errores
{
	public:
		...
		enum NUM_ERRORES {
			...
			ERROR_CONVERSION_STRICT,      // Error 2004
			...
			ERROR_OFFSET_INVALIDO_FUNCTION,  //2019
			ERROR_OPERADOR_ACCESO_CLASE_INVALIDO, // Error 2020
			ERROR_INTEGER_OVERFLOW,	// Error 2021
			ERROR_DOUBLE_OVERFLOW,	// Error 2022
			ERROR_OPERATION_DOUBLE_OPERATOR,	// Error 2023
			ERROR_SINTAXIS_PARENTESIS,	// Error 2024
			ERROR_ASIGNACION_FALLO, //Error 2025
			ERROR_INCLUDE_FALLO, //Error 2026
			ERROR_INCLUDE_RUTA_INVALIDA, //Error 2027
			ERROR_INCLUDE_PARAMETRO, //Error 2028
			ERROR_INCLUDE_REF_CIRCULAR, //Error 2029
			ERROR_INCLUDE_REQ_ALREADY, //Error 2030
			...
			ERROR_FUNCION_NO_DECLARADA_HA, // Error 4006
			ERROR_FORMAT_NO_ACEPTADA, // Error 4007
			ERROR_REGEX_NOT_MATCH, // Error 4008
			ERROR_REGEX_VAR_NOT_AVAILABLE_TRANSFORM, // Error 4009
			ERROR_INPUT_NOT_MATCH, // Error 4010
			ERROR_REGEX_INVALID, // Error 4011
			ERROR_FUNCTION_PARAMETER, // Error 4012
			...
			ERROR_CLASE_CONSTRUCTOR_SENTENCIA_ERROR, // Error 4502
			...
			ERROR_CLASE_CALL_VARIABLE_NO_EXISTE, //Error 4513
			ERROR_CLASE_VAR_PRIVATE, //Error 4514
			ERROR_CLASE_STATIC_FUNCTION_CALL_NOT_STATIC_VAR, //Error 4515
			ERROR_CLASE_STATIC_FUNCTION_NOT_FOUND, //Error 4516
			ERROR_CLASE_STATIC_ACCESS, //Error 4517
			ERROR_CLASE_STATIC_VAR_NOT_FOUND, //Error 4518
			ERROR_CLASE_STATIC_ACCESS_NOT_PRIVATE, //Error 4519
			ERROR_CLASE_VAR_NOT_EXIST, //Error 4520
			ERROR_CLASE_ATOMIC_VAR_NOT_EXIST, //Error 4521
			ERROR_CLASE_ATOMIC_FUNCTION_NOT_EXIST, //Error 4522
			ERROR_CLASE_ATOMIC_FUNCTION_PARAMETER, //Error 4523
			ERROR_CLASE_NO_DECLARADA, // Error 4524
			ERROR_CLASE_CORE_FUNCTION_NOT_EXIST, // Error 4525
			ERROR_CLASE_CORE_CONSTRUCTOR, // Error 4526


			ERROR_CLASE_CORE_FILE_NOT_OPENED, // Error 5000
			ERROR_CLASE_CORE_FILE_FAIL_OPEN, // Error 5001
			ERROR_CLASE_CORE_FILE_OUT_INDEX, // Error 5002
			ERROR_CLASE_CORE_FILE_NOT_READ, // Error 5003
			ERROR_CLASE_CORE_FILE_NOT_WRITE, // Error 5003
